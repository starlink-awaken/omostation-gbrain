...
gbrain is the eCOS v6 Postgres knowledge database. See [`../README.md`](../README.md) for a quick overview and [`../CAPABILITY-MAP.md`](../CAPABILITY-MAP.md) for capabilities.
