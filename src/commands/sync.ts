...
// Re-export test-facing helpers so test/sync.test.ts and test/e2e/sync-cjk-git.test.ts
// keep importing buildGitInvocation / buildAutoEmbedArgs / resolveSlugByPathOrSourcePath
// from commands/sync.ts unchanged (F7114ABA SRP wave 1 backward-compat).
export * from './sync-helpers.ts';
