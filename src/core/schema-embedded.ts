...
CREATE TABLE IF NOT EXISTS pages (
  ...
  -- v0.38.0 MemTheta (Phase 1): access metrics and confidence. Search
  -- ranking reads these directly; keep fresh installs and upgrade paths in
  -- lockstep with src/schema.sql and the engine query surface.
